...
写到 runs_full_detail/victory 和 runs_full_detail/failure。
...
输出结构：
  runs_full_detail/victory/details/run_details_NNNNNN.jsonl  (每 shard 2000 行)
  runs_full_detail/failure/details/run_details_NNNNNN.jsonl
  runs_full_detail/SUMMARY.json  (源统计)

重跑时自动覆盖 runs_full_detail。
"""
...
def main() -> None:
    ...
    jobs = [
        ("victory", root / "runs_victory" / "details", root / "runs_full_detail" / "victory" / "details"),
        ("failure", root / "runs_failure" / "details", root / "runs_full_detail" / "failure" / "details"),
    ]
    ...
    summary_path = root / "runs_full_detail" / "SUMMARY.json"
