...
- 当前项目主题只保留两块：`STS2AI/Python/game_bridge` 与 `STS2AI/Python/data/skada`。
...
- `STS2AI/Python/game_bridge`：bridge、session、spectate、sim 相关 Python 代码。
- `STS2AI/Python/data/skada`：skada 抓取、明细构建、覆盖率扫描等数据脚本。
